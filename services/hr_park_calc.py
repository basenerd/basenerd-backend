...
_STADIUMS = {
    ...
    "ST_LAA": {
        ...
        "elevation": 1160, "temp": 78,
        "dist": [
            (-2733.9773, -8.04111, 0, 22.5),
            (1014.3409, 2.415463, 22.5, 45),
            (382.7032, 0.288629, 45, 67.5),
            (360.0, 0.128287, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_OAK": {
        "name": "Hohokam Stadium",
        "elevation": 1240, "temp": 78,
        "dist": [
            (-3191.9507, -9.38809, 0, 22.5),
            (930.5574, 2.201963, 22.5, 45),
            (422.6035, 0.45414, 45, 67.5),
            (350.0, -0.038645, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_ATH": {
    ...
    "ST_MIL": {
        ...
        "elevation": 1090, "temp": 78,
        "dist": [
            (14167.7621, 40.47932, 0, 22.5),
            (902.3834, 2.190407, 22.5, 45),
            (400.9714, 0.417648, 45, 67.5),
            (340.0, -0.012963, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_SF": {
        "name": "Scottsdale Stadium",
        "elevation": 1260, "temp": 78,
        "dist": [
            (-171647.6654, -476.799071, 0, 22.5),
            (1140.7628, 2.751819, 22.5, 45),
            (384.3528, 0.264086, 45, 67.5),
            (330.0, -0.114663, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_SD": {
        "name": "Peoria Sports Complex",
        "elevation": 1140, "temp": 78,
        "dist": [
            (-7559.0182, -22.232407, 0, 22.5),
            (1040.6171, 2.589402, 22.5, 45),
            (401.8755, 0.38619, 45, 67.5),
            (340.0, -0.044979, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_SEA": {
    ...
    "ST_KC": {
        ...
        "elevation": 1180, "temp": 78,
        "dist": [
            (-337648.028, -964.708652, 0, 22.5),
            (861.9351, 2.047401, 22.5, 45),
            (420.9899, 0.488424, 45, 67.5),
            (350.0, -0.001037, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_TEX": {
    ...
    "ST_CWS": {
        ...
        "elevation": 1120, "temp": 78,
        "dist": [
            (-11807.9214, -34.225859, 0, 22.5),
            (999.9257, 2.449045, 22.5, 45),
            (408.2921, 0.408322, 45, 67.5),
            (345.0, -0.029218, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_LAD": {
    ...
    "ST_CHC": {
        "name": "Sloan Park",
        "elevation": 1230, "temp": 78,
        "dist": [
            (-4653.0458, -14.100139, 0, 22.5),
            (1153.0816, 2.977326, 22.5, 45),
            (387.2877, 0.335872, 45, 67.5),
            (330.0, -0.070921, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    # ── Spring Training — Grapefruit League (Florida) ─────────────
    "ST_NYY": {
        "name": "Steinbrenner Field",
        "elevation": 15, "temp": 78,
        "dist": [
            (-959.0682, -3.015938, 0, 22.5),
            (777.475, 1.694891, 22.5, 45),
            (425.823, 0.475992, 45, 67.5),
            (314.0, -0.282989, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_BOS": {
        ...
        "elevation": 15, "temp": 78,
        "dist": [
            (-1119.828, -3.612348, 0, 22.5),
            (1145.7723, 2.858016, 22.5, 45),
            (402.9705, 0.356872, 45, 67.5),
            (302.0, -0.337466, 67.5, 90),
        ],
        "height": [(37, 0, 0, 22.5), (8, 0, 22.5, 90)],
    },
    "ST_BAL": {
        "name": "Ed Smith Stadium",
        "elevation": 20, "temp": 78,
        "dist": [
            (-26229.0873, -77.144374, 0, 22.5),
            (960.0702, 2.394361, 22.5, 45),
            (400.9714, 0.417648, 45, 67.5),
            (340.0, -0.012963, 67.5, 90),
        ],
        "height": [(7, 0, 0, 90)],
    ...
    "ST_DET": {
        ...
        "elevation": 210, "temp": 78,
        "dist": [
            (-26229.0873, -77.144374, 0, 22.5),
            (1325.9362, 3.464659, 22.5, 45),
            (382.7032, 0.288629, 45, 67.5),
            (340.0, -0.012963, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    ...
    "ST_MIA": {
        ...
        "elevation": 20, "temp": 78,
        "dist": [
            (-3030.6661, -9.046765, 0, 22.5),
            (852.5076, 2.01407, 22.5, 45),
            (411.9706, 0.456536, 45, 67.5),
            (325.0, -0.149504, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_STL": {
    ...
    "ST_PIT": {
        ...
        "elevation": 15, "temp": 78,
        "dist": [
            (-4196.8871, -12.528021, 0, 22.5),
            (902.3834, 2.190407, 22.5, 45),
            (411.9706, 0.456536, 45, 67.5),
            (335.0, -0.079821, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_TB": {
        "name": "Charlotte Sports Park",
        "elevation": 10, "temp": 78,
        "dist": [
            (-4282.5074, -12.485444, 0, 22.5),
            (980.8141, 2.350436, 22.5, 45),
            (417.2902, 0.425453, 45, 67.5),
            (343.0, -0.080093, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_TOR": {
        ...
        "elevation": 10, "temp": 78,
        "dist": [
            (-9458.7719, -28.23514, 0, 22.5),
            (985.7563, 2.485175, 22.5, 45),
            (386.0638, 0.364942, 45, 67.5),
            (327.0, -0.060241, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_PHI": {
        ...
        "elevation": 10, "temp": 78,
        "dist": [
            (-1611.6353, -4.898588, 0, 22.5),
            (856.7756, 1.969764, 22.5, 45),
            (393.2421, 0.363059, 45, 67.5),
            (330.0, -0.083588, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_NYM": {
        "name": "Clover Park",
        "elevation": 25, "temp": 78,
        "dist": [
            (-6423.5998, -19.004733, 0, 22.5),
            (1055.0821, 2.639296, 22.5, 45),
            (399.7589, 0.378889, 45, 67.5),
            (338.0, -0.052618, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_ATL": {
        ...
        "elevation": 20, "temp": 78,
        "dist": [
            (2861.7442, 7.631318, 0, 22.5),
            (808.957, 1.860095, 22.5, 45),
            (411.9706, 0.456536, 45, 67.5),
            (325.0, -0.149504, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    ...
    "ST_HOU": {
        ...
        "elevation": 20, "temp": 78,
        "dist": [
            (-3900.2616, -11.854898, 0, 22.5),
            (1099.2478, 2.810224, 22.5, 45),
            (391.1603, 0.355844, 45, 67.5),
            (330.0, -0.077272, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
    "ST_WSH": {
    ...
    "ST_MIN": {
        ...
        "dist": [
            (-4653.0458, -14.100139, 0, 22.5),
            (1063.9014, 2.715022, 22.5, 45),
            (391.8574, 0.368321, 45, 67.5),
            (330.0, -0.070921, 67.5, 90),
        ],
        "height": [(8, 0, 0, 90)],
    },
...
def stadiums_hr_count(
    ...
    # Only count the 30 MLB stadiums (not ST_ spring training parks)
    mlb_total = sum(1 for k in _STADIUMS if not k.startswith("ST_"))
    ...
    for team, info in _STADIUMS.items():
        # Skip spring training parks — only use 30 MLB stadiums for count
        if team.startswith("ST_"):
            continue
